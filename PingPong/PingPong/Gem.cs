...
namespace PingPong
{
    class Gem : Rectangle
    {
        ...
        public Gem(System.Windows.Shapes.Rectangle rectangle, MainWindow mainWindow,
            System.Windows.Shapes.Rectangle paddle, Ball ball) : base(rectangle, mainWindow)
        {
            _paddle = paddle;
            _ball = ball;
        ...
        {
            Console.WriteLine("{0} gem activated", _gemType);
            ...
            switch (_gemType)
            {
                ...
                case GemType.Shortener:
                    ...
                    break;
                case GemType.Slower:
                    Console.WriteLine($"Level before: {_ball.getLevel()}");
                    _ball.SetLevel(_ball.getLevel() / 2);
                    Console.WriteLine($"Level after: {_ball.getLevel()}");
                    break;
        ...
        {
            Console.WriteLine("deactivate gem: {0}", _gemType);
